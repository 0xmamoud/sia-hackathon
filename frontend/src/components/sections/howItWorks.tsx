const SingleFeature = ({ feature }: { feature: any }) => {
    ...
    // Log the icon to ensure it's a valid React element
    console.log(icon);

    return (
        <div className="w-full">
            <div className="wow fadeInUp" data-wow-delay=".15s">
                <div className="mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-blue-700 bg-opacity-10 text-primary">
                    {icon} {/* Ensure this is a valid React element */}
                </div>
...
const featuresData = [
  {
    ...
    paragraph:
        "Construit pour s'adapter à vos rapports, notre outil conduit son analyse pour s'adapter parfaitement à vos traitements et recherches.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Sécurité",
    paragraph:
        "Une protection permanante des données traitées : aucune information sensible ne sort du périmètre de l'entreprise lors des multiples traitements effectués.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Performance",
    paragraph:
        "Utilisation de méthodes à la pointe de la technologie, conçu grâce aux outils IA les plus avancés.",
  },
];
